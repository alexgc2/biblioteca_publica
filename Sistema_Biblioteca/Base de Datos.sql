...
(
ID_PRESTAMOL INT PRIMARY KEY NOT NULL, 
ID_MIEM INT FOREIGN KEY (ID_MIEM) REFERENCES MEMBRESIA (ID_MIEMBRO),
NOMBRE_M VARCHAR(MAX),
APELLIDO VARCHAR(MAX),
OCUPACION VARCHAR(50),
ID_LIBROS INT FOREIGN KEY (ID_LIBROS) REFERENCES LIBROS (ID_LIBRO),
NOMBRE_L VARCHAR(MAX),
AUTOR VARCHAR(MAX),
VOLUMEN VARCHAR(5),
AREA VARCHAR(50),
CANTIDAD INT,
...
ID_EM INT FOREIGN KEY (ID_EM) REFERENCES EMPLEADO (ID_EMPLEADO)
)

CREATE TABLE PRESTAMO_COMPUTADORA
(
ID_PRESTAMOC INT PRIMARY KEY NOT NULL, 
