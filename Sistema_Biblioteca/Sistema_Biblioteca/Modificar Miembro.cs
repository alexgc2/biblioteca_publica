...
namespace Sistema_Biblioteca
{
    public partial class Modificar_Miembro : Form
    {
        ...
        {
            conexion.llenarModificarMiembro(Convert.ToInt32(txtID.Text),sexo,txtNombre,txtApellido,cmbTipo,txtTelefono,txtDireccion,txtEmail,txtOcupacion,txtPago);
            if (sexo == "masculino")
            {
                rdFem.Checked = true;
            }
        ...
        {
            conexion.llenar_ComboBoxPago(cmbTipo);
        }
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            {
                conexion.modificar_miembro(txtNombre.Text, txtApellido.Text, txtOcupacion.Text, txtDireccion.Text, txtTelefono.Text, sexo1, txtEmail.Text, Convert.ToInt32(txtPago.Text), cmbTipo.Text);
